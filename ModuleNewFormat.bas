Attribute VB_Name = "ModuleNewFormat"
...
Sub RDB_Merge_Data_BrowseNume()
    ...
    If Not oFolder Is Nothing Then
        ...
        If myCountOfFiles = 0 Then
            ...
            Exit Sub
        End If
        myValueName = InputBox("The name of the sheet where the information will be copied")
        Get_Data _
                FileNameInA:=True, _
                PasteAsValues:=True, _
                SourceShName:=myValueName, _
                SourceShIndex:=0, _
                SourceRng:="A1:XFD1048576", _
                StartCell:="", _
                myReturnedFiles:=myFiles
...
Sub RDB_Merge_Data_BrowseIndex()
    ...
    If Not oFolder Is Nothing Then
        ...
        If myCountOfFiles = 0 Then
            ...
            Exit Sub
        End If
        myValueIndex = InputBox("The number of the sheet where the information will be copied:")
        Get_Data _
                FileNameInA:=True, _
                PasteAsValues:=True, _
                SourceShName:="", _
